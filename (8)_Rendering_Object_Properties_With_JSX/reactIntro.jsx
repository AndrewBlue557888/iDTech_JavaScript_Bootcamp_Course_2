...
class ReactIntro extends React.Component {
  ...
  this.setState({ initialized: true, productName: "Rice Krispies", productDescription: "a cereal made of popped rice", productPrice: "$3.00" });
  ...
  render() {
    ...
    // using `` instead of "" does matter in this
    const stringToReturn = `The product name is ${this.state.productName}, product description is ${this.state.productDescription}, and product price is ${this.state.productPrice}.`;
